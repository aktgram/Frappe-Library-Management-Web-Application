<script>
	/**
	 * @type {{ title: any; authors: any; num_pages: any; language_code: any; average_rating: any; publisher: any; }}
	 */
	export let book;
...
<!-- <div class="card p-4 bookcard">
	...
	<p>Reviews: {book.text_reviews_count}</p>
	<p>Publication Date: {book.publication_date}</p>
	<p>Publisher: {book.publisher}</p>
	<p>Stock: {book.stock}</p>
	<div>
		<button type="button" class="btn variant-filled-secondary" on:click={openDrawer(book)}
			>Issue</button
		>
	</div>
</div> -->
